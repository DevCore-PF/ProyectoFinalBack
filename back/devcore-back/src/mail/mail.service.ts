...
export class MailService {
  ...
  async sendRejectCourseEmail(
    ...
    await this.transporter.sendMail({
      from: '"DevCore" <noreply@tuapp.com>',
      to: email,
      subject: `⚠️ Tu curso "${courseTitle}" ha sido rechazado`,
      html: `
    <!DOCTYPE html>
    <html lang="es">
      <head>
                ...
                <tr>
                  <td style="background-color:#363968;text-align:center;padding:45px 30px;">
                    ...
                    <h1 style="margin:0;color:#fff;font-size:26px;font-weight:700;">
                      Tu curso ha sido rechazado ⚠️
                    </h1>
                    <p style="margin:10px 0 0;color:rgba(255,255,255,0.85);font-size:15px;">
                      Revisión finalizada para tu curso <strong>${courseTitle}</strong>
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:50px 40px;background-color:#242645;">
                    <p style="margin:0 0 25px;color:#d1d5db;font-size:16px;line-height:1.7;">
                      ...
                      Luego de revisar tu curso, lamentamos informarte que no ha sido aprobado en esta instancia.
                    </p>

                    <table width="100%" cellpadding="0" cellspacing="0" 
                      style="background-color:#1d1f3a;border-radius:10px;padding:25px;border-left:4px solid #fbbf24;margin-bottom:30px;">
                      <tr>
                        <td>
                          <h3 style="margin:0 0 12px 0;color:#fbbf24;font-size:17px;">
                            Motivo del rechazo
                          </h3>
                          <p style="color:#d1d5db;font-size:15px;line-height:1.7;margin:0;font-style:italic;">
                            "${reason}"
                          </p>
                        </td>
                      </tr>
                    ...
                    <p style="margin:0 0 25px;color:#d1d5db;font-size:15px;line-height:1.7;">
                      Esto no es definitivo. Podés corregir los detalles mencionados y volver a enviarlo para revisión cuando estés listo.
                    </p>

                    <table width="100%" cellpadding="0" cellspacing="0" style="margin:35px 0;">
                      <tr>
                        <td align="center">
                          <div style="display:inline-block;background-color:#3a321b;border:1px solid rgba(251,191,36,0.4);color:#fbbf24;padding:12px 28px;border-radius:8px;font-weight:600;font-size:15px;">
                            ⚠️ Estado del curso: Rechazado
                          </div>
                        </td>
                      </tr>
                    </table>
                    ...
                    <p style="margin:0;color:#a0aec0;font-size:14px;line-height:1.6;">
                      Gracias por tu esfuerzo y dedicación. Queremos ayudarte a mejorarlo y volver a intentarlo 💫
                    </p>
                  </td>
                </tr>
  ...
  /**
   * NUEVO MÉTODO
   * Envía un email al profesor confirmando la aprobación de su perfil.
   */
  async sendProfileApprovedEmail(
    ...
    const userName = name;
    // Asumo que el login URL del frontend es '/login'
    const loginUrl = `${process.env.FRONTEND_URL}/login`; 

    await this.transporter.sendMail({
      from: '"DevCore" <noreply@tuapp.com>',
      to: email,
      subject: `✅ ¡Tu solicitud de Profesor en DevCore fue aprobada!`,
      html: `
    <!DOCTYPE html>
    <html lang="es">
      <head>
                ...
                <tr>
                  ...
                  >
                    ...
                    <p
                      ...
                      "
                    >
                      Bienvenido oficialmente a la comunidad DevCore 💜
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 50px 40px; background-color: #242645">
                    ...
                    >
                      ¡Felicitaciones,
                      <strong style="color: #a78bfa">${userName}</strong>! Tu
                      solicitud fue revisada y ha sido
                      <strong style="color: #4ade80">aprobada exitosamente</strong>.
                    </p>
                    ...
                    <p
                      ...
                      "
                    >
                      Ya podés acceder a tu cuenta y explorar todas las
                      funcionalidades que <strong>DevCore</strong> tiene para vos.
                    </p>
