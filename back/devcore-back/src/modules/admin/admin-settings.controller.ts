...
import { ApiGetAbandonedCartSettingsDoc } from './doc/getCartSettings.doc';
import { ApiUpdateAbandonedCartSettingsDoc } from './doc/updateCardSettings.doc';
import { ApiTriggerAllRemindersDoc } from './doc/sendAllreminders.doct';
import { ApiGetAbandonedCartDashboardDoc } from './doc/getDashboardStatus.doc';
...
export class AdminSettingsController {
   ...
   */
  @Get('abandoned-cart')
  @ApiGetAbandonedCartSettingsDoc()
  ...
  @ApiUpdateAbandonedCartSettingsDoc()
  ...
  @ApiGetAbandonedCartDashboardDoc()
  async getDashboardStats() {
    ...
    const lastExecution = await this.settingsService.getSetting(
      'ABANDONED_CART_LAST_EXECUTION',
      '',
    );
